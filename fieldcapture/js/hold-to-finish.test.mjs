...
assert.match(html, /js\/capture-core\.js\?v=places/);
assert.match(html, /js\/app\.js\?v=places/);
assert.match(html, /Search Google for the site address/);
assert.match(html, /aria-controls="new-job-address-list"/);
assert.match(html, /\.addr-list/);
assert.match(appSrc, /function bindAddressLookup/);
assert.match(appSrc, /function resolveNewJobSite/);
assert.match(appSrc, /Core\.placesAutocomplete/);
assert.match(appSrc, /Core\.placesDetails/);
assert.match(appSrc, /Core\.placesResolve/);
assert.match(appSrc, /placeId: site\.placeId/);
