    ...
    <div className="cx-aurora flex h-svh flex-col bg-paper-100">
      <header className="shrink-0 border-b border-line bg-paper-0/90 backdrop-blur">
        <div className="flex items-start">
          <div className="flex min-w-0 flex-1 items-start justify-between gap-4 px-6 py-5">
            <Logo to={null} />
          ...
          {/* Same width as the Ask column in JobFileAskChrome so job meta stays
              over the file, not on top of "Ask this job". */}
          <div className="hidden lg:block lg:w-[min(32rem,42%)] lg:shrink-0" aria-hidden />
        </div>
      </header>
