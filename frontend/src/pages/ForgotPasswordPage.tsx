          ...
          <div className="rounded-2xl border border-line/10 bg-surface/70 p-8 shadow-2xl shadow-scrim/40 backdrop-blur-xl sm:p-10">
            {sent ? (
              <>
                ...
                <h1 className="mt-5 text-2xl font-bold tracking-tight text-fg">Check your email</h1>
                <p className="mt-2 text-sm leading-relaxed text-fg-3">
                  If an account exists for <span className="text-fg-2">{email.trim()}</span>, we've
              ...
              <>
                ...
                <form onSubmit={handleSubmit} noValidate className="mt-6 space-y-4">
                  <div>
                    <label htmlFor="email" className="mb-1.5 block text-sm font-medium text-fg-2">
                      Email
                    </label>
                    <input
                      id="email"
