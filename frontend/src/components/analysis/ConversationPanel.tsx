...
export function ConversationPanel({
  ...
  return (
    ...
    >
      ...
      {brief && (
        <p className="mt-2 text-[13.5px] leading-relaxed text-ink-900" data-testid="conversation-brief">
          {brief}
        </p>
      )}
      {rooms.length > 0 && (
        <p className="mt-1.5 text-[11px] leading-relaxed text-ink-500">
          Rooms & scope mentioned: {rooms.join(', ')}
        </p>
      )}
              ...
              const row = (
                <>
                  ...
                  <span className="min-w-0 space-y-1">
                    ...
                    <span className="block text-[13px] leading-relaxed text-ink-800">{moment.text}</span>
                    {moment.quote ? (
                      <span className="block text-[11px] italic leading-relaxed text-ink-500">
                        “{moment.quote}”
                      </span>
      ...
      {turns.length > 0 && (
        <details className="mt-4" data-testid="conversation-turns-details">
