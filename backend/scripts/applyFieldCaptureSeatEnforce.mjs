#!/usr/bin/env node
/**
 * Apply Field Capture seat-limit triggers so concurrent joins/invites
 * cannot mint unpaid seats.
 *
...
console.warn(
  'Skipping Field Capture seat-enforcement SQL apply — add SUPABASE_ACCESS_TOKEN (or DATABASE_URL / SUPABASE_DB_PASSWORD).',
);
