...
export const config = {
  ...
  verification: {
    ...
    synthesisModel: resolveAnthropicModel(process.env.LONG_FORM_SYNTHESIS_MODEL),
  ...
  anthropic: {
    ...
    apiKey: process.env.ANTHROPIC_API_KEY ?? '',
    defaultModel: resolveAnthropicModel(process.env.ANTHROPIC_DEFAULT_MODEL),
  },
  ...
  stripe: {
    ...
    /**
     * Annual prices ($3,990 / $8,490 / $19,990 / $1,250). No live fallback —
     * yearly checkout stays hidden until every one of these is a price id.
     * Placeholders until the annual Stripe prices exist.
     */
