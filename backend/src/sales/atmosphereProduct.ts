...
export const ATMOSPHERE_PRODUCT_BLURB =
  ...
  'work verification, field capture, computer use, carrier/supplier web access, ' +
...
export const DEFAULT_VALUE_PROP =
  'Atmosphere helps restoration and construction teams verify work from field capture, ' +
  'operate carrier and supplier portals with AI, run field tech workflows, and keep a full ' +
...
export const DEMO_CTA =
  'a short product demo (live walkthrough of work verification, field capture, and web access)';
...
export function demoMeetingDescription(salesFocus: string): string {
  return (
    ...
    "We'll show work verification, field capture, web access, and how the audit trail works."
  );
}
