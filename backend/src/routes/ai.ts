...
aiRouter.use(requireAuth, requireOrg);
 ...
 */
aiRouter.post('/count-tokens', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
aiRouter.post('/messages', async (req: Request, res: Response, next: NextFunction) => {
  try {
