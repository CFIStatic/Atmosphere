...
### Business Portal (internal analytics) access

`/business` (and legacy `/analytics`) is gated by `public.analytics_staff`. Atmosphere staff emails in
...
`/business/product` under **A/B tests**.
